...
def sobol(kstart=0, m=None, s=None, scramble = True, deepcopy=True):
    ...
    gen = digitalseq_b2g("/Users/tanvipotdar/Projects/Advanced-Numerical-Methods/montecarlo/sobol_Cs.col", kstart=kstart, m=m, s=s, returnDeepCopy=deepcopy)
    ...
    if scramble == False:
        ...
        shift = randint(2**t, size=(1,s)) # generate random shift
