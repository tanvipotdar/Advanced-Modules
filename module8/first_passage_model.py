...
def at1p(V0, H0, B, sigma, r, t):
	...
	intensity[0] = -np.log(survival_prob[0])/dt[0]
	...
	result.columns = ['maturity', 'firm_value', 'H', 'surv_prob', 'default_intensity']
	return result


cds_data = get_cds_data()
df = at1p(V0=1, H0=0.7,B=0.4,sigma=np.repeat(0.1, 10), r=cds_data.spread, t=cds_data.maturity)
